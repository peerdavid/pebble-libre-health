...
- Hourly step tracking with 24-hour breakdown
- Heart rate and sleep data sync
- Automatic background sync every 30 minutes
- Manual send with one button press
- Works on all Pebble platforms (Aplite, Basalt, Chalk, Diorite, Emery)

**Your data stays yours.** All data is sent directly to Libre Health on your phone — no cloud, no accounts, no third parties.

## Controls

- **UP:** Enable automatic sync
- **SELECT:** Send data now
- **DOWN:** Disable automatic sync

## Companion App
Store - https://play.google.com/store/apps/details?id=tirol.peer.librehealth <br/>
GitHub - https://github.com/peerdavid/libre-health
